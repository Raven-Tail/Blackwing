...
namespace Blackwing.Interceptor
{
    ...
    {
        [InterceptsLocation(1, "WM6dZkpY/bgUnFfOyVBwc8kCAAA=")] // (27,35)
        public static ValueTask<TResponse> Send_Blackwing_Test_Integration_Ping<TResponse>(this global::Blackwing.Contracts.ISender sender, IRequest<TResponse> request, CancellationToken cancellationToken = default)
        {
            ...
            var task = sender.Send<global::Blackwing.Test.Integration.Ping, global::Blackwing.Test.Integration.Result<global::Blackwing.Test.Integration.Pong>>(rqst!, cancellationToken);
            return Unsafe.As<ValueTask<global::Blackwing.Test.Integration.Result<global::Blackwing.Test.Integration.Pong>>, ValueTask<TResponse>>(ref task);
        }
