...
public sealed record AddTodoItem(string Title, string Text) : IRequest<TodoItem>, IValidate
{
...
public sealed class TodoItemCommandHandler : IRequestHandler<AddTodoItem, TodoItem>
{
